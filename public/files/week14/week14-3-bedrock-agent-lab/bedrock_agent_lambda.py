...
def lambda_handler(event: dict, context: Any) -> dict:
    ...
    # 디버깅을 위한 함수 호출 정보 로깅
    logger.info(f"Action: {action_group}, Function: {function}")
...
def get_reservation(params: dict) -> dict:
    """
    예약 번호로 예약 정보를 조회합니다.
...
def create_reservation(params: dict) -> dict:
    """
    새로운 예약을 생성합니다.
...
def list_reservations(params: dict) -> dict:
    """
    예약 목록을 조회합니다.
...
def cancel_reservation(params: dict) -> dict:
    """
    예약을 취소합니다.
