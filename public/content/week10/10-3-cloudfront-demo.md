...
7. **Bucket name**에 `quicktable-cloudfront-origin-YOUR-INITIALS-12345`를 입력합니다.

> [!TIP]
> `YOUR-INITIALS`를 본인의 이니셜로, `12345`를 랜덤 숫자로 변경합니다 (예: `quicktable-cloudfront-origin-jdoe-98765`).
...
95. **Publish** 탭에서 [[Add association]] 버튼을 클릭합니다.
...
> [!NOTE]
> `<버킷이름>`을 태스크 1에서 생성한 버킷 이름으로 변경합니다 (예: `BUCKET_NAME=quicktable-cloudfront-origin-jdoe-98765`).
