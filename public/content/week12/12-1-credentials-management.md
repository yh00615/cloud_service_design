...
<img src="/images/week12/12-1-task0-step4-create-stack.png" alt="CloudFormation Create stack 드롭다운에서 With new resources (standard) 선택" class="guide-img-md" />
...
14. `I acknowledge that AWS CloudFormation might create IAM resources with customised names` 체크박스를 선택합니다.
    ...
    <img src="/images/week12/12-1-task0-step14-capabilities.png" alt="CloudFormation Capabilities 체크박스" class="guide-img-sm" />
...
64. **Last rotated date**에 값이 표시되는지 확인합니다. 최대 5분 소요될 수 있으므로 페이지를 새로고침하며 기다립니다.
...
50. Amazon S3 콘솔에서 `cf-templates-`로 시작하는 버킷을 찾습니다.
